...
const Footer = () => {
  return (
    <footer className="bg-secondary-900 text-white border-t border-secondary-800 mt-16">
      <div className="max-w-7xl mx-auto px-6 md:px-10 py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        {/* Links Column */}
        <div>
          <h3 className="font-semibold text-white mb-4 text-sm uppercase tracking-wider">Discover</h3>
          <ul className="space-y-3 text-secondary-300 text-sm">
            <li><Link to="/accounts/book" className="hover:text-primary-400 transition-colors">Apartments</Link></li>
            <li><Link to="/accounts/book" className="hover:text-primary-400 transition-colors">Luxury Villas</Link></li>
            <li><Link to="/accounts/book" className="hover:text-primary-400 transition-colors">Beach Houses</Link></li>
            <li><Link to="/accounts/book" className="hover:text-primary-400 transition-colors">Trending</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3 text-secondary-300 text-sm">
            ...
            <li><Link to="/" className="hover:text-primary-400 transition-colors">Safety Information</Link></li>
            <li><Link to="/" className="hover:text-primary-400 transition-colors">Cancellation Options</Link></li>
        ...
        <div>
          ...
          <p className="text-secondary-300 text-sm mb-4">Subscribe to get special offers and updates.</p>
          <div className="flex gap-2">
            <input
              type="email"
              placeholder="Email address"
              className="flex-1 bg-secondary-800 border border-secondary-700 rounded-lg px-3 py-2 text-sm text-white placeholder-secondary-400 focus:outline-none focus:border-primary-500 focus:ring-1 focus:ring-primary-500"
            />
