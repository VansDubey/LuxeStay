...
const Booking = () => {
  ...
  return (
    ...
    <>
      ...
      <div className="min-h-screen bg-secondary-50 pt-[80px]"> {/* Wrappper for spacing */}
        <div className="max-w-7xl mx-auto px-6 md:px-10 py-8"> {/* Container */}

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 p-4 m-7">
